        ...
        if (!fork()) { // this is the child process
			...
			if (strncmp(buf, "GET", 3) == 0) {
                    ...
                    if ((buf_int < 20000) && (buf_int > 0)) {
                        int isvalid = 0;
                        if (tank[id_int]1[0] <> 0) {
                            if (abs(tank[id_int][0] - buf_int) < 200) {
                                isvalid = 1;
                            } else {
                                if (tank[id_int]1[1] <> 0) {
                                    if (abs(tank[id_int][1] - buf_int) < 200) {
                                        isvalid = 1;
                                    } else {
                                    }
                                }
                        ...
                        tank[id_int][2]=tank[id_int][1];
                        tank[id_int][1]=but_int;
